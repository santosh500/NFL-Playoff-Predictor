...
rushLogisticModel <- glm(Label ~ TD + Yds + Yds.G + Fum + FumL + Avg, data=trainingData)
summary(rushLogisticModel)
...
#Obtain predictions
predictionsMain <- predict(rushLogisticModel, mainData,type="response")
