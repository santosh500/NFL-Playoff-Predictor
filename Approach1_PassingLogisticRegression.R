...
passLogisticModel <- glm(Label ~ TD + QBR + Pct + Yds + YdsG + Int, data=trainingData)
summary(passLogisticModel)
...
#Obtain predictions
predictionsMain <- predict(passLogisticModel, mainData,type="response")
